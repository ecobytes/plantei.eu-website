<div class="panel panel-default" data-actions>
    <div class="panel-heading">
        ...
        <a style="color: black;" href="#" data-toggle="collapse" data-target=".collapse.category-options">{{ trans('forum::categories.actions') }}</a>
    </div>
    <div class="collapse category-options">
        <div class="panel-body">
            ...
            <div class="form-group hidden" data-depends="rename">
                ...
                <input type="text" id="new-title" name="title" value="{{ $category->title }}" class="form-control" autocomplete="off">
                <label for="new-description">{{ trans('forum::general.description') }}</label>
                <input type="text" id="new-description" name="description" value="{{ $category->description }}" class="form-control" autocomplete="off">
            </div>
        </div>
