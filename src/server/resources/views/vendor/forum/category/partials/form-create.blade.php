<form action="{{ Forum::route('category.store') }}" method="POST">
    ...
    <div class="panel panel-default">
        <div class="panel-heading">
            ...
            <a style="color: black;" href="#" data-toggle="collapse" data-target=".collapse.create-category">{{ trans('forum::categories.create') }}</a>
        </div>
        <div class="collapse create-category">
            <div class="panel-body">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="description" value="{{ old('description') }}" class="form-control" autocomplete="off">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input type="number" id="weight" name="weight" value="{{ !empty(old('weight')) ? old('weight') : 0 }}" class="form-control" autocomplete="off">
                </div>
                <div class="form-group">
                    <label>
